...
layout_coluna1 = [
    [sg.Text('Nome*', size=(10, 1), expand_x=True, expand_y=True, font=font)], [sg.InputText(key='nome', expand_x=True, expand_y=True, size=(30, 1), font=font)],
    [sg.Text('Data de nascimento', expand_x=True, expand_y=True, font=font),  sg.Text('(dd/mm)', expand_x=True, expand_y=True, size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='nascimento', size=(30, 1), expand_x=True, expand_y=True, font=font, enable_events=True)],
    [Text('CEP', size=(10, 1), expand_x=True, expand_y=True, font=font)], [sg.InputText(key='cep', size=(30, 1), expand_x=True, expand_y=True, font=font, enable_events=True), sg.Button('Consultar CEP', expand_x=True, expand_y=True)]
]

layout_coluna2 = [
    [Text('Logradouro', expand_x=True, expand_y=True, size=(10, 1),   font=font)], [sg.InputText(key='logradouro', expand_x=True, expand_y=True, size=(30, 1), font=font)],
    [Text('Número', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='numero', size=(30, 1), expand_x=True, expand_y=True, font=font)],
    [Text('Complemento', expand_x=True, expand_y=True, size=(11, 1), font=font)], [sg.InputText(key='complemento', expand_x=True, expand_y=True, size=(30, 1), font=font)],
]

layout_coluna3 = [
    [Text('Bairro', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='bairro', expand_x=True, expand_y=True, size=(30, 1), font=font)],
    [Text('Cidade', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='cidade', expand_x=True, expand_y=True, size=(30, 1), font=font)],
    [Text('UF', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='uf', expand_x=True, expand_y=True, size=(30, 1), font=font)],
]

layout_coluna4 = [
    [Text('E-mail', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='email', expand_x=True, expand_y=True, size=(30, 1),font=font)],
    [sg.Text('Telefone', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='telefone', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
    [Text('Instagram', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='instagram', expand_x=True, expand_y=True, size=(30, 1), font=font)],
]

layout_coluna5 = [
    [Push(), Text('Obs:', expand_x=True, expand_y=True), sg.Multiline(key='obs', expand_x=True, expand_y=True, size=(100, 6)), Push()],
]

layout_botoes = [
    [Push(), Button('Registrar eleitor', expand_x=True, expand_y=True), Push(), Button('Exibir Eleitores', expand_x=True, expand_y=True), Push(), Button('Fechar'), Push()],
]

dados_exibidos = False  # Variável para controlar se os dados dos eleitores foram exibidos

layout = [
    [Column(layout_coluna1), VSeparator(),
     Column(layout_coluna2), VSeparator(),
     Column(layout_coluna3), VSeparator(),
     Column(layout_coluna4)],
    [(layout_coluna5)],
    [layout_botoes]
]
...
def criar_janela_exibir_eleitores(total_eleitores):
    ...
    layout_botoesSegundaTela = [
        ...
        sg.Button('Limpar Filtros', key='-LIMPAR-FILTROS-', size=(10, 1)), sg.Button('Deletar Eleitor', size=(10, 1)), sg.Button('Imprimir', key='-IMPRIMIR-', size=(10, 1)), sg.Button('Fechar', size=(10, 1)), ],
    ]

    layout_fecharExibicao = [
        [sg.Table(values=(dados_formatados), headings=['Matrícula', 'Nome', 'Nascimento', 'CEP','Logradouro', 'Número', 'Complemento', 'Bairro', 'Cidade', 'UF', 'E-mail', 'Telefone', 'Instagram', 'OBS'], auto_size_columns=False,
              justification='center', key='-OUTPUT-', num_rows=min(50, len(dados_formatados)), size =(800,400)), ],
