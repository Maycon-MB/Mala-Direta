...
layout_coluna4 = [
    [Text('E-mail', expand_x=True, expand_y=True, font=font)], [sg.InputText(key='email', expand_x=True, expand_y=True,font=font)],
    [sg.Text('Telefone', expand_x=True, expand_y=True, font=font)], [sg.InputText(key='telefone', expand_x=True, expand_y=True, font=font, enable_events=True)],
