...
def create_pdf(data):
    ...
    # Divida os dados em grupos de 3 para criar três colunas
    data_groups = [data[i:i + 3] for i in range(0, len(data), 3)]

    # Crie as colunas
    for group in data_groups:
        data_table = [[person['name'], person['address']] for person in group]
...
data = [
    ...
    {'name': 'Nome 3', 'address': 'Endereço 3'},
    {'name': 'Nome 4', 'address': 'Endereço 4'},
    # Adicione as outras 23 pessoas aqui
]
