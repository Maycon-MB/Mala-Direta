...
layout_coluna1 = [
    ...
    [Text('CEP', size=(10, 1), font=font)], [sg.InputText(key='cep', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True), Button('Consultar CEP', expand_x=True, expand_y=True)]
]
