...
def generate_pdf(file_path, data):
    pdf = FPDF()
    pdf.add_page()
    pdf.set_font("Helvetica", size=16)  # Aumente o tamanho da fonte
    ...
    item_width = page_width  # Largura total da página
    ...
    for i, item in enumerate(data):
        ...
        x = 0  # A coluna ocupa a largura total da página
        y = (((i % 27) // 3) + 0.01) * item_height  # Adiciona 0.01 à coordenada Y para ajustar o alinhamento
...
generate_pdf("FullScreenPDF.pdf", data)
