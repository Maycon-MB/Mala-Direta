...
def generate_pdf(file_path, data):
    pdf = FPDF()
    pdf.add_page()
    pdf.set_font("Helvetica", size=14)  # Ajuste o tamanho da fonte
    ...
    # Ajuste o deslocamento vertical (Y) para descer o conteúdo em 1 milímetro
    vertical_offset = 2.83  # 1 milímetro em unidades FPDF
