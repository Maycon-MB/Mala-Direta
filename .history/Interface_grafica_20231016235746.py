...
def generate_pdf(filename, data):
    ...
    for label in data:
        ...
        c.drawString(x + 5, y - rect_height + 5, label, space=0)
...
def etiqueta_Nascimento():
    ...
    for eleitor in eleitores_filtrados:
        ...
        etiqueta_text = (
            f"{eleitor[1].upper()}<br><br>{eleitor[4]}, {eleitor[5]}, {eleitor[6]}<br>{eleitor[7]}, {eleitor[8]} - {eleitor[9]}<br>{cep_formatado}                               {eleitor[2]}"
        )
...
def etiqueta_Geral():
    ...
    for eleitor in eleitores_completos:
        ...
        etiqueta_text = (
            f"{eleitor[1].upper()}<br><br>{eleitor[4]}, {eleitor[5]}, {eleitor[6]}<br>{eleitor[7]}, {eleitor[8]} - {eleitor[9]}<br><br>{cep_formatado}"
        )
