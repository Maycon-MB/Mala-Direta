...
def criar_janela_exibir_eleitores(total_eleitores):
    ...
    layout_fecharExibicao = [
        [sg.Table(table_rows, headings=['Matrícula', 'Nome', 'Nascimento', 'CEP', 'Logradouro', 'Número', 'Complemento', 'Bairro', 'Cidade', 'UF', 'E-mail', 'Telefone', 'Instagram', 'OBS'],
                auto_size_columns=False, justification='center', num_rows=min(50, len(dados_formatados)),
                expand_x=True, expand_y=True, col_widths=[15]*len(dados_formatados[0]))]
