    ...
    while True:
        ...
        if event == 'Gerar PDF':
            ...
            for item in contents:
                data.append([Paragraph(item, style)])  # Uma linha por item

            # Calculando o tamanho dos retângulos para preencher a página
            page_width, page_height = letter
            col_width = page_width / 3
            row_height = page_height / 9  # Defina o valor de acordo com o número de retângulos desejado

            # Crie uma tabela com 3 colunas
            table = Table(data, colWidths=[col_width] * 3, rowHeights=[row_height] * 9)  # Defina o número de retângulos desejado
