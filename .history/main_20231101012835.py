...
def criar_janela_edicao(data):
    layout = [
        ...
        [sg.Text('Nome:', size=12, justification='right'), sg.Push(), sg.InputText(data[1], size=(400,1), key='nome', expand_x=True, expand_y=True)],
        [sg.Text('Nascimento:', size=12, justification='right'), sg.Push(), sg.InputText(data[2], size=(20,1), key='nascimento', expand_x=True, expand_y=True)],
        [sg.Text('CEP:', size=12, justification='right'), sg.Push(), sg.InputText(data[3], size=(20,1), key='cep', expand_x=True, expand_y=True)],
        [sg.Text('Logradouro:', size=12, justification='right'), sg.Push(), sg.InputText(data[4], size=(20,1), key='cep', expand_x=True, expand_y=True)],
        [sg.Text('Número:', size=12, justification='right'), sg.Push(), sg.InputText(data[5], size=(20,1), key='numero', expand_x=True, expand_y=True)],
        [sg.Text('Complemento:', size=12, justification='right'), sg.Push(), sg.InputText(data[6], size=(20,1), key='complemento', expand_x=True, expand_y=True)],
        [sg.Text('Bairro:', size=12, justification='right'), sg.Push(), sg.InputText(data[7], size=(20,1), key='bairro', expand_x=True, expand_y=True)],
        [sg.Text('Cidade:', size=12, justification='right'), sg.Push(), sg.InputText(data[8], size=(20,1), key='cidade', expand_x=True, expand_y=True)],
        [sg.Text('UF:', size=12, justification='right'), sg.Push(), sg.InputText(data[9], size=(20,1), key='uf', expand_x=True, expand_y=True)],
        [sg.Text('E-mail:', size=12, justification='right'), sg.Push(), sg.InputText(data[10], size=(20,1), key='email', expand_x=True, expand_y=True)],
        [sg.Text('Telefone:', size=12, justification='right'), sg.Push(), sg.InputText(data[11], size=(20,1), key='telefone', expand_x=True, expand_y=True)],
        [sg.Text('Instagram:', size=12, justification='right'), sg.Push(), sg.InputText(data[12], size=(20,1), key='instagram', expand_x=True, expand_y=True)],
        [sg.Text('Obs:', size=12, justification='right'), sg.Push(), sg.InputText(data[13],size=(20,1), key='obs', expand_x=True, expand_y=True)],
        [sg.Text('Zona:', size=12, justification='right'), sg.Push(), sg.InputText(data[14],size=(20,1), key='zona', expand_x=True, expand_y=True)],
        [sg.Text('Seção:', size=12, justification='right'), sg.Push(), sg.InputText(data[15],size=(20,1), key='secao', expand_x=True, expand_y=True)],
        [sg.Text('Local:', size=12, justification='right'), sg.Push(), sg.InputText(data[16],size=(20,1), key='local', expand_x=True, expand_y=True)],
        [sg.Button('Salvar')],
    ]
