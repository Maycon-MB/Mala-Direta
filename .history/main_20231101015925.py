...
# 1. Criar a lista focusable_elements com as chaves dos elementos que podem receber foco
focusable_elements3 = ['nome', 'nascimento', 'cep', 'Consultar CEP', 'logradouro', 'numero', 'complemento', 'bairro', 'cidade', 'uf', 'email', 'telefone', 'instagram', 'zona', 'secao', 'local', 'obs', 'Registrar eleitor', 'Exibir Eleitores', 'Fechar']
...
while tentativas > 0:
    ...
    # Quando Enter é pressionado, mova o foco para o próximo elemento
        ...
        janela_login[focusable_elements2[current_focus2]].set_focus()
