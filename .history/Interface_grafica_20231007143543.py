...
layout = [
    [Column(layout_coluna1, expand_x=True, expand_y=True), VSeparator(),
     Column(layout_coluna2, expand_x=True, expand_y=True), VSeparator(),
     Column(layout_coluna3, expand_x=True, expand_y=True), VSeparator(),
     Column(layout_coluna4, expand_x=True, expand_y=True)],
    [(layout_coluna5, expand_x=True, expand_y=True)],
    [layout_botoes]
]
