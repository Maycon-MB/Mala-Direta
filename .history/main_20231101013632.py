...
focusable_elements2 = ['nome', 'nascimento', 'cep', 'Consultar CEP', 'logradouro', 'numero', 'complemento', 'bairro', 'cidade', 'uf', 'email', 'telefone', 'instagram', 'zona', 'secao', 'local', 'obs', ]
                ...
                if selected_index is not None:
                    ...
                    while True:
                        ...
                        if edit_event == '\r':
                            ...
                            edit_window[focusable_elements[current_focus2]].set_focus()
