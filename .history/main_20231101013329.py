            ...
            if eventos_eleitores == 'Editar Tabela':
                ...
                if selected_index is not None:
                    ...
                    while True:
                        ...
                        if edit_event == '\r':
                            # Quando Enter é pressionado, mova o foco para o próximo elemento
                            current_focus = (current_focus2 + 1) % len(focusable_elements2)
                            elemento_com_foco = focusable_elements[current_focus2]
                            janela[focusable_elements[current_focus2]].set_focus()
