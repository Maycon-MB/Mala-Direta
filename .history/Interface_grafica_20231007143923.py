...
layout_coluna1 = [
    ...
    [sg.Text('Data de nascimento', expand_x=True, expand_y=True, font=font),  sg.Text('(dd/mm)', size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='nascimento', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
