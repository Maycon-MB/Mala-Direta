        ...
        while True:
            ...
            if eventos_eleitores == sg.WINDOW_CLOSED or eventos_eleitores == 'Fechar':
                ...
                if eventos_eleitores == 'Editar Tabela':
                    ...
                    print(f"selected_index: {selected_index}")  # Add this line to check the value
                    if selected_index is not None:
                        selected_index = int(selected_index)  # Convert to integer
                        selected_id = eleitores_filtrados[selected_index][0]  # Get the ID of the selected record
                    else:
                        print("Invalid selected_index or index out of range.")
