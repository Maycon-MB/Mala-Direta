...
for line in lines:
    if "eleitor[4]" in line or "eleitor[5]" in line or "eleitor[6]" in line or "eleitor[7]" in line or "eleitor[8]" in line or "eleitor[9]" in line:
        pdf.set_line_height(2)  # Define a altura da linha como 2 (espaçamento menor)
    else:
        pdf.set_line_height(5)  # Define a altura da linha como 5 (espaçamento padrão)
