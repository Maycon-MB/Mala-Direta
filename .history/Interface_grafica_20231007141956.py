...
layout_coluna3 = [
    [Text('Bairro', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='bairro', size=(30, 1), font=font)],
    [Text('Cidade', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='cidade', size=(30, 1), font=font)],
