...
layout_coluna4 = [
    ...
    [sg.Text('Telefone', expand_x=True, expand_y=True, size=(10, 1), font=font), Push(), ], [sg.InputText(key='telefone', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
