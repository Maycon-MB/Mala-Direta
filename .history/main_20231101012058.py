...
def criar_janela_edicao(data):
    layout = [
        ...
        [sg.Text('Logradouro:', justification='right'), Push(), sg.InputText(data[4], size=(20,1), key='cep', expand_x=True, expand_y=True)],
        [sg.Text('Número:', justification='right'), Push(), sg.InputText(data[5], size=(20,1), key='numero', expand_x=True, expand_y=True)],
