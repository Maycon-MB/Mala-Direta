...
# Cores de fundo alternadas para linhas pares e ímpares
background_color_odd = 'blue'
background_color_even = 'red'  # Cor de fundo das linhas pares (substitui o preto)
text_color_even = 'blue'       # Cor do texto das linhas pares
...
def criar_janela_exibir_eleitores(total_eleitores):
    ...
    layout_fecharExibicao = [
            [sg.Table(values=dados_formatados, headings=['Matrícula', 'Nome', 'Nascimento', 'CEP', 'Logradouro', 'Número', 'Complemento', 'Bairro', 'Cidade', 'UF', 'E-mail', 'Telefone', 'Instagram', 'OBS'],
                        ...
                        text_color='white', alternating_row_color='gray')],
