...
layout_coluna1 = [
    ...
    [Text('CEP', size=(10, 1), font=font)], [sg.InputText(key='cep', size=(30, 1), expand_x=True, expand_y=True, font=font, enable_events=True), sg.Button('Consultar CEP', expand_x=True, expand_y=True)]
]
