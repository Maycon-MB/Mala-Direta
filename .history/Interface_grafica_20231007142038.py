...
layout_coluna4 = [
    [Text('E-mail', size=(10, 1), font=font), expand_x=True, expand_y=True], [sg.InputText(key='email', expand_x=True, expand_y=True, size=(30, 1),font=font)],
    [sg.Text('Telefone', size=(10, 1), font=font), expand_x=True, expand_y=True], [sg.InputText(key='telefone', size=(30, 1), font=font, enable_events=True)],
