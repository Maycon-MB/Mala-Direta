...
layout_coluna4 = [
    ...
    [sg.Text('Telefone', size=(10, 1), font=font), Push(), sg.Text('9999-9999', size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='telefone', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
    [Text('Instagram', size=(10, 1), font=font)], [sg.InputText(key='instagram', expand_x=True, expand_y=True, size=(30, 1), font=font)],
]

layout_coluna5 = [
    [Push(), Text('Obs:'), sg.Multiline(key='obs', expand_x=True, expand_y=True, size=(100, 6)), Push()],
]
