    ...
    if eventos == 'Exibir Eleitores':
        ...
        while True:
            ...
            def formatar_eleitor(eleitor):
                if len(eleitor) >= 14:
                    return '\t'.join(map(str, [eleitor[1], eleitor[2], eleitor[3], eleitor[4], eleitor[5], eleitor[6], eleitor[7], eleitor[8], eleitor[9], eleitor[10], eleitor[11], eleitor[12], eleitor[13], eleitor[14], eleitor]))
                else:
