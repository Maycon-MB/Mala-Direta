...
def generate_pdf(file_path, data):
    ...
    for i, item in enumerate(data):
        ...
        for line in lines:
            if "eleitor[1]" in line or "cep_formatado" in line:
                pdf.set_font("Arial", size=11)  # Define a fonte como Arial com tamanho 11
                reduce_spacing = False  # Desativa a redução do espaçamento
            elif "eleitor[4]" in line or "eleitor[5]" in line or "eleitor[6]" in line or "eleitor[7]" in line or "eleitor[8]" in line or "eleitor[9]" in line:
