...
Traceback (most recent call last):
  File "G:\Mala_Direta_Eduardo\Interface_grafica.py", line 639, in <module>
    etiqueta_Nascimento()
TypeError: etiqueta_Nascimento() missing 1 required positional argument: 'eleitores_filtrados'
