...
background_color_odd = '#FFFFFF'  # Branco para linhas ímpares
background_color_even = '#E0E0E0'  # Cinza claro para linhas pares
...
[sg.Table(values=dados_formatados, headings=['Matrícula', 'Nome', 'Nascimento', 'CEP', 'Logradouro', 'Número', 'Complemento', 'Bairro', 'Cidade', 'UF', 'E-mail', 'Telefone', 'Instagram', 'OBS'],
              ...
              text_color='black', alternating_row_color='lightgray')],
