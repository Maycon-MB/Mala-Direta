...
layout_coluna4 = [
    [Text('E-mail', size=(10, 1), font=font)], [sg.InputText(key='email', expand_x=True, expand_y=True, size=(30, 1),font=font)],
    [sg.Text('Telefone', size=(10, 1), font=font), Push(), sg.Text('9999-9999', expand_x=True, expand_y=True, size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='telefone', size=(30, 1), font=font, enable_events=True)],
    [Text('Instagram', size=(10, 1), font=font)], [sg.InputText(key='instagram', size=(30, 1), font=font)],
]
