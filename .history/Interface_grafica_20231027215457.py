...
def criar_janela_exibir_eleitores(total_eleitores):
    ...
    layout_botoesSegundaTela = [
        [sg.Combo(['Etiqueta Geral','Etiqueta com Nascimento', 'Relatório por Instagram', 'Relatório por E-mail', 'Relatório por Telefone', 'Relatório por OBS', 'Relatório por Bairro', 'Relatório por Cidade', 'Relat'], key='-COMBO-'),
