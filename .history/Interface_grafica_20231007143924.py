...
layout_coluna1 = [
    [sg.Text('Nome*', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='nome', expand_x=True, expand_y=True, size=(30, 1), font=font)],
    [sg.Text('Data de nascimento', expand_x=True, expand_y=True, font=font),  sg.Text('(dd/mm)', expand_x=True, expand_y=True, size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='nascimento', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
    [Text('CEP', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='cep', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True), Button('Consultar CEP', expand_x=True, expand_y=True)]
]
...
layout_coluna2 = [
    ...
    [Text('Número', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='numero', expand_x=True, expand_y=True, size=(30, 1), font=font)],
...
layout_coluna4 = [
    ...
    [sg.Text('Telefone', expand_x=True, expand_y=True, size=(10, 1), font=font), Push(), sg.Text('9999-9999', size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='telefone', expand_x=True, expand_y=True, size=(30, 1), font=font, enable_events=True)],
