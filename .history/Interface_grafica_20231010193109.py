...
layout_coluna1 = [
    [sg.Text('Nome*', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.Text('Nome*', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='nome', size=(20, 1), expand_x=True, expand_y=True, font=font, enable_events=True, k='-nome_key-')],
