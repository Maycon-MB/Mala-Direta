...
def criar_janela_edicao(data):
    layout = [
        [sg.Text('Matrícula:', justification='right'), Push() sg.Text(data[0]) ],
        [sg.Text('Nome:',justification='right'), sg.InputText(data[1], size=(20,1), key='nome', expand_x=True, expand_y=True)],
