...
def converter_nome_maiusculas(evento, valor, janela):
    texto_em_maiusculas = valor.upper()
    janela[evento].update(texto_em_maiusculas)
...
layout_coluna1 = [
    [sg.Text('Nome*', expand_x=True, expand_y=True, size=(10, 1), font=font)], sg.InputText(key='nome', size=(20, 1), expand_x=True, expand_y=True, font=font, enable_events=True, key='nome_key')
    ...
    [Text('CEP', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='cep', expand_x=True, expand_y=True, size=(20, 1), font=font, enable_events=True), Button('Consultar CEP', size=(20, 1), expand_x=True, expand_y=True)]
]

layout_coluna2 = [
    [Text('Logradouro', expand_x=True, expand_y=True, size=(10, 1),   font=font)], [sg.InputText(key='logradouro', size=(20, 1), expand_x=True, expand_y=True, font=font)],
    [Text('Número', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='numero', size=(20, 1), expand_x=True, expand_y=True, font=font)],
    [Text('Complemento', expand_x=True, expand_y=True, size=(11, 1), font=font)], [sg.InputText(key='complemento', size=(20, 1), expand_x=True, expand_y=True, font=font)],
]

layout_coluna3 = [
    [Text('Bairro', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='bairro', expand_x=True, expand_y=True, size=(20, 1), font=font)],
    [Text('Cidade', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='cidade',expand_x=True, expand_y=True, size=(20, 1),font=font)],
    [Text('UF', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='uf', expand_x=True, expand_y=True, size=(20, 1), font=font)],
]

layout_coluna4 = [
    [Text('E-mail', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='email', size=(20, 1), expand_x=True, expand_y=True,font=font)],
    [sg.Text('Telefone', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='telefone', size=(20, 1), expand_x=True, expand_y=True, font=font, enable_events=True)],
    [Text('Instagram', expand_x=True, expand_y=True, size=(10, 1), font=font)], [sg.InputText(key='instagram', size=(20, 1), expand_x=True, expand_y=True, font=font)],
]
