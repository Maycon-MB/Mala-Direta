...
focusable_elements2 = ['nome', 'nascimento', 'cep', 'Consultar CEP', 'logradouro', 'numero', 'complemento', 'bairro', 'cidade', 'uf', 'email', 'telefone', 'instagram', 'zona', 'secao', 'local', 'obs', 'Registrar eleitor', 'Exibir Eleitores', 'Fechar']
            ...
            if eventos_eleitores == 'Editar Tabela':
                ...
                if selected_index is not None:
                    ...
                    while True:
                        ...
                        if edit_event == '\r':
                            # Quando Enter é pressionado, mova o foco para o próximo elemento
                            current_focus2 = (current_focus + 1) % len(focusable_elements)
                            elemento_com_foco = focusable_elements2[current_focus]
                            edit_window[focusable_elements2[current_focus]].set_focus()
