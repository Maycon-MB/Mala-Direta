...
layout_coluna4 = [
    ...
    [sg.Text('Telefone', size=(10, 1), font=font), Push(), sg.Text('9999-9999', size=(16,1), font=("Helvetica", 10))], [sg.InputText(key='telefone', size=(30, 1), font=font, enable_events=True)],
