...
def generate_pdf(file_path, data):
    pdf = PDF()
    pdf.add_page()
    pdf.set_font("Arial", size=10)  # Define o tamanho padrão da fonte como 10

    page_width = pdf.w
    page_height = pdf.h
    # Ajuste a largura das colunas
    item_width = (page_width - 2) / 3  # Defina o valor "2" conforme necessário
    ...
    for i, item in enumerate(data):
        ...
        for line in lines:
            if "eleitor[1]" in line or "cep_formatado" in line:  # Verifica os campos que precisam de tamanho diferente
                ...
                pdf.set_font("Arial", size=10)  # Define a fonte como Helvetica com tamanho 10
