...
def criar_janela_exibir_eleitores(total_eleitores):
    ...
    layout_fecharExibicao = [
        [sg.Table(values=dados_formatados, headings=['Matrícula', 'Nome', 'Idade', 'Cor Favorita'], auto_size_columns=False,
                    justification='center', num_rows=min(25, len(dados_formatados)), key='-OUTPUT-', expand_x=True, expand_y=True,
                    background_color='white', size=(800, 400),
                    display_row_numbers=False, col_widths=[10, 100, 50, 100],
                    auto_size_columns=True, justification='right',
                    text_color='black', font='Helvetica 12', border_width=1,
                    alternating_row_color='lightgray', num_rows=10, row_height=30,
                    vertical_scroll_only=False, right_click_menu=['&Right', ['Item 1', 'Item 2']],
