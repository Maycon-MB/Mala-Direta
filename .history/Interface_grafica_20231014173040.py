...
def generate_pdf(file_path, data):
    pdf = FPDF()
    pdf.add_page()
    pdf.set_font("Helvetica", size=10)  # Ajuste o tamanho da fonte
    ...
    # Valor de deslocamento para reduzir o espaçamento vertical
    line_spacing = 2  # Ajuste esse valor conforme necessário
    ...
    for i, item in enumerate(data):
        ...
        row = (i % 27) // 3
        x = col * item_width
        y = row * item_height  # Move todos os itens um pouco para baixo
        y += (row * line_spacing)  # Adicione o deslocamento
