...
import sys
import os
# Importe a função strstr do módulo re
...
def generate_pdf(file_path, data):
    ...
    for i, item in enumerate(data):
        ...
        for line in lines:
            if "eleitor[4]" in line and "eleitor[5]" in line and "eleitor[6]" in line and "eleitor[7]" in line and "eleitor[8]" in line and "eleitor[9]" in line:
