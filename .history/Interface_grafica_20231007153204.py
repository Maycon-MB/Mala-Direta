...
for i, row_data in enumerate(dados_formatados):
    if i % 2 == 0:
        # Linha par
        row = [sg.Text(text, background_color=background_color_even, justification='center') for text in row_data]
    else:
        # Linha ímpar
        row = [sg.Text(text, background_color=background_color_odd, justification='center') for text in row_data]
