...
# Função para criar o PDF com retângulos e preencher com dados
def create_pdf_with_rectangles(file_path, data):
    ...
    for i, item in enumerate(data):
        ...
        c.drawString(x + 5, y - rect_height + 5, item)
...
# Função para criar etiquetas com nascimento
def etiqueta_Nascimento(eleitores_filtrados, pdf_filename):
    ...
    create_pdf_with_rectangles(pdf_filename, etiqueta_data)

# Função para criar etiquetas gerais
def etiqueta_Geral(eleitores_completos, pdf_filename):
