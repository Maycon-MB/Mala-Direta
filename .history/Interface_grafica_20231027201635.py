...
focusable_elements = ['nome', 'nascimento', 'cep', 'Consultar CEP', 'logradouro', 'numero', 'complemento', 'bairro', 'cidade', 'uf', 'email', 'telefone', 'instagram', 'zona', sewcao 'obs', 'Registrar eleitor', 'Exibir Eleitores', 'Fechar']
