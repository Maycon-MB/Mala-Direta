...
def criar_janela_edicao(data):
    layout = [
        [sg.Text('Matrícula:', justification='right'), sg.Text(data[0]) ],
        [sg.Text('Nome:',justification='right'), sg.Push(), sg.InputText(data[1], size=(20,1), key='nome', expand_x=True, expand_y=True)],
        [sg.Text('Nascimento:', justification='right'), sg.Push(), sg.InputText(data[2], size=(20,1), key='nascimento', expand_x=True, expand_y=True)],
        [sg.Text('CEP:', justification='right'), sg.Push(), sg.InputText(data[3], size=(20,1), key='cep', expand_x=True, expand_y=True)],
        [sg.Text('Logradouro:', justification='right'), sg.Push(), sg.InputText(data[4], size=(20,1), key='cep', expand_x=True, expand_y=True)],
        [sg.Text('Número:', justification='right'), sg.Push(), sg.InputText(data[5], size=(20,1), key='numero', expand_x=True, expand_y=True)],
        [sg.Text('Complemento:', justification='right'), sg.Push(), sg.InputText(data[6], size=(20,1), key='complemento', expand_x=True, expand_y=True)],
        [sg.Text('Bairro:', justification='right'), sg.Push(), sg.InputText(data[7], size=(20,1), key='bairro', expand_x=True, expand_y=True)],
