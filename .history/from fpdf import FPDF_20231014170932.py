...
def generate_pdf(file_path, data):
    ...
    for i, item in enumerate(data):
        ...
        # Ajuste o valor de y para a primeira linha (linhas 1, 2 e 3) em relação às outras linhas
        if row == 0:
            y = 0  # Itens 1, 2 e 3 mais próximos dos itens 4, 5 e 6
        else:
            y = row * item_height
...
generate_pdf("MultiColumnAdjustedPDF.pdf", data)
