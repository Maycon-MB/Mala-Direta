...
def generate_pdf(file_path, data):
    ...
    pdf.set_font("Arial", size=7)  # Define o tamanho da fonte como 7

    page_width = 70  # Largura da página em mm
    page_height = 33  # Altura da página em mm

    item_width = page_width / 3
    item_height = page_height / 9

    vertical_spacing = 0.5  # Ajuste o valor conforme necessário
    horizontal_spacing = 0.5  # Ajuste o valor conforme necessário
    ...
    for i, item in enumerate(data):
        ...
        for line in lines:
            pdf.set_xy(x, y)
            pdf.multi_cell(item_width, item_height / 2, line, border=0, align="L")
